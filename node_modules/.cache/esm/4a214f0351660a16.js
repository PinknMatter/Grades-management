let express,Router,engine,sqlite3,open,cookieParser;_516‍.w("express",[["default",["express"],function(v){express=v}],["Router",["Router"],function(v){Router=v}]]);_516‍.w("express-handlebars",[["engine",["engine"],function(v){engine=v}]]);_516‍.w("sqlite3",[["default",["sqlite3"],function(v){sqlite3=v}]]);_516‍.w("sqlite",[["open",["open"],function(v){open=v}]]);_516‍.w("cookie-parser",[["default",["cookieParser"],function(v){cookieParser=v}]]);
...
app.post('/addStudent', (req,res) => {
    _516‍.g.console.log(req.body)
    res.redirect('addStudent')
})
app.get('/addStudent', async (req,res) => {
    const db = await dbPromise
    const c_idtemp = await db.get("SELECT c_id FROM Courses WHERE name = ?;", req.cookies.course)
    c_id = Object.values(c_idtemp).toString()
    var StudentNotInClass = await db.all("SELECT Users.u_id,Users.username FROM Users WHERE Users.u_id NOT IN(SELECT Users.u_id FROM Users,Grades WHERE Users.u_id = Grades.u_id AND Users.priv ='student' AND Grades.c_id = ?) AND priv = 'student';", c_id)
    _516‍.g.console.log(StudentNotInClass)
