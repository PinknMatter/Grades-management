let express,Router,engine,sqlite3,open,cookieParser;_f15‍.w("express",[["default",["express"],function(v){express=v}],["Router",["Router"],function(v){Router=v}]]);_f15‍.w("express-handlebars",[["engine",["engine"],function(v){engine=v}]]);_f15‍.w("sqlite3",[["default",["sqlite3"],function(v){sqlite3=v}]]);_f15‍.w("sqlite",[["open",["open"],function(v){open=v}]]);_f15‍.w("cookie-parser",[["default",["cookieParser"],function(v){cookieParser=v}]]);
...
app.post('/addStudent', async (req,res) => {
    ...
    await db.run("INSERT INTO Grades (u_id, c_id, teacherName) VALUES (?,?);", req.body[0], Object.values(c_id).toString(), req.cookies.user)
