let express,Router,engine,sqlite3,open,cookieParser,session;_d18‍.w("express",[["default",["express"],function(v){express=v}],["Router",["Router"],function(v){Router=v}]]);_d18‍.w("express-handlebars",[["engine",["engine"],function(v){engine=v}]]);_d18‍.w("sqlite3",[["default",["sqlite3"],function(v){sqlite3=v}]]);_d18‍.w("sqlite",[["open",["open"],function(v){open=v}]]);_d18‍.w("cookie-parser",[["default",["cookieParser"],function(v){cookieParser=v}]]);_d18‍.w("express-session",[["default",["session"],function(v){session=v}]]);
...
app.post('/editGrades', async (req,res) => {
    ...
    for (let i=0; i<keys.length; i++){
        ...
        if(!Number.isInteger(g1)||!Number.isInteger(g2)||!Number.isInteger(g3)||g1>100||g1<0||g2>100||g2<0||g3>100||g3<0){
